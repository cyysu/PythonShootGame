...
while running:
    ...
    if enemy_frequency % 50 == 0:
        ...
        enemy1 = Enemy(enemy1_img, enemy1_down_imgs, enemy1_pos) # 建立精灵
        enemies1.add(enemy1)                                     # 建立Add方法将精灵添加进去
    enemy_frequency += 1
    ...
    for bullet in player.bullets:
        # 以固定速度移动子弹
        bullet.move()
        # 移动出屏幕后删除子弹        由于子弹向上移动因此可以根据rect的属性bottom进行确定
